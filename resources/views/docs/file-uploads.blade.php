...
From the developers perspective, handling file inputs is no different than handing any other input type: Add `wire:model` to the `<input>` tag and everything else is taken care of for you.
